...
export default async function CryptsPage({
  params,
}: {
              ...
              >
                ...
                >
                  ...
                  <div className="flex items-end">
                    {/* No delete: crypts is a shared master table — use is_active to disable */}
                    <button
